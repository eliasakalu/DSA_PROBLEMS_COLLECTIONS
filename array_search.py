'''
Array Search
Difficulty: BasicAccuracy: 40.95%Submissions: 492K+Points: 1Average Time: 15m
...
'''
#Several times I did this so check my git repository 
from binary_search import binarySearch # This is my binaryfunction inside binary_search.py
